...
function handleCake() {
    ...
    if (!isLit) {
        ...
        flame.classList.remove('hidden');
        button.textContent = 'يلا تاني';
        hasWished = false;
    }
}

function showWishMade() {
    alert('ربنا ينولك كل اللي بتتمنيه يحبيبتي اللهم امين');
}

// Wishes carousel
const wishes = [
    "أتمني أكون معاكي طوووول عمري",
    "أتمني اكون دايما الراجل اللي بتحلمي بيه",
    "أتمني اقدر اسعدك وابينلك قد ايه انا بحبك فكل مناسبة وغير مناسبة",
    "انا بحبك اوي يا شيماء , انا متيم بيكي",
